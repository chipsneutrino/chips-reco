...
WCSimScatteringTableManager::~WCSimScatteringTableManager(){
  ...
  if(fScatteringFile != 0x0) delete fScatteringFile;
  if(fScatteringTableTop != 0x0) delete fScatteringTableTop;
  if(fScatteringTableBarrel != 0x0) delete fScatteringTableBarrel;
  if(fScatteringTableBottom != 0x0) delete fScatteringTableBottom;
...
int WCSimScatteringTableManager::CalculateBin(int dimension, float value, int pmtLocation){
  ...
  if(pmtLocation == 0) thisTable = fScatteringTableTop;
  if(pmtLocation == 1) thisTable = fScatteringTableBarrel;
  if(pmtLocation == 2) thisTable = fScatteringTableBottom;
