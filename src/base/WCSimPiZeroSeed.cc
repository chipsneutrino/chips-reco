...
WCSimPiZeroSeed::WCSimPiZeroSeed(WCSimLikelihoodTrackBase* track1, WCSimLikelihoodTrackBase* track2, double minus2LnL) {
	// These are always new'ed so this class can take responsibility for deleting them
	fTrack1 = WCSimLikelihoodTrackFactory::MakeTrack(track1->GetType(), track1->GetX(), track1->GetY(), track1->GetZ(),
			track1->GetT(), track1->GetTheta(), track1->GetPhi(), track1->GetE(), track1->GetConversionDistance());
	fTrack2 = WCSimLikelihoodTrackFactory::MakeTrack(track2->GetType(), track2->GetX(), track2->GetY(), track2->GetZ(),
			track2->GetT(), track2->GetTheta(), track2->GetPhi(), track2->GetE(), track2->GetConversionDistance());
