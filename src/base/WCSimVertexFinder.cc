...
static void point_position_chi2(Int_t &, Double_t *, Double_t &f, Double_t *par, Int_t)
{
	...
	fgVertexFinder->PointPositionChi2(vtxX, vtxY, vtxZ, vtime, fom);
...
static void point_direction_chi2(Int_t &, Double_t *, Double_t &f, Double_t *par, Int_t)
{
	...
	fgVertexFinder->PointDirectionChi2(vtxX, vtxY, vtxZ, dirX, dirY, dirZ, vangle, fom);
...
static void point_vertex_chi2(Int_t &, Double_t *, Double_t &f, Double_t *par, Int_t)
{
	...
	fgVertexFinder->PointVertexChi2(vtxX, vtxY, vtxZ, dirX, dirY, dirZ, vangle, vtime, fom);
...
static void extended_vertex_chi2(Int_t &, Double_t *, Double_t &f, Double_t *par, Int_t)
{
	...
	fgVertexFinder->ExtendedVertexChi2(vtxX, vtxY, vtxZ, dirX, dirY, dirZ, vangle, vtime, fom);
													  ...
													  Double_t dirY, Double_t dirZ)
{
	...
	this->PointDirectionChi2(vtxX, vtxY, vtxZ, dirX, dirY, dirZ, vtxAngle, dirFOM);
												   ...
												   Double_t dirY, Double_t dirZ)
{
	...
	// figure of merit
	// ===============
	this->PointVertexChi2(vtxX, vtxY, vtxZ, dirX, dirY, dirZ, vtxAngle, vtxTime, vtxFOM);
													  ...
													  Double_t dirY, Double_t dirZ)
{
	...
	// figure of merit
	// ===============
	this->ExtendedVertexChi2(vtxX, vtxY, vtxZ, dirX, dirY, dirZ, vtxAngle, vtxTime, vtxFOM);
...
WCSimRecoVertex *WCSimVertexFinder::FitPointDirectionWithMinuit(WCSimRecoVertex *myVertex)
{
	...
	// calculate vertex
	// ================
	this->PointDirectionChi2(vtxX, vtxY, vtxZ, dirX, dirY, dirZ, vtxAngle, vtxFOM);
										  ...
										  Double_t &fom)
{
	...
	// truncate
	if (fom < -999.999 * fBaseFOM)
		fom = -999.999 * fBaseFOM;
										   ...
										   Double_t dirZ, Double_t &vtxAngle, Double_t &fom)
{
	...
	// calculate residuals
	// ===================
	this->PointResiduals(vtxX, vtxY, vtxZ, dirX, dirY, dirZ);
										   ...
										   Double_t dirZ, Double_t &vtxAngle, Double_t &vtxTime, Double_t &fom)
{
	...
	// calculate residuals
	// ===================
	this->ExtendedResiduals(vtxX, vtxY, vtxZ, dirX, dirY, dirZ);
...
void WCSimVertexFinder::FitExtendedConePropertiesLnL(Double_t &coneAngle, Double_t &coneFOM)
{
	...
	this->ConePropertiesLnL(fitParam0, fitParam1, fitParam2, fitAngle, fom);
