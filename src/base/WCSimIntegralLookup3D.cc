...
WCSimIntegralLookupHistArray::WCSimIntegralLookupHistArray() : fEMin(-999), fEMax(-999), fR0Min(-999), fR0Max(-999), fR0Bins(-999), fCosTheta0Min(-999), fCosTheta0Max(-999), fCosTheta0Bins(
																																												  -999),
															   fRhoInt(NULL), fRhoSInt(NULL), fRhoSSInt(NULL), fRhoSSpline(NULL), fRhoSSSpline(NULL)
{
}

WCSimIntegralLookupHistArray::WCSimIntegralLookupHistArray(double EMin, double EMax, double R0Max, double R0Min,
														   int R0Bins, double cosTh0Max, double cosTh0Min, int cosTh0Bins) : fEMin(EMin), fEMax(EMax), fR0Min(R0Min), fR0Max(R0Max), fR0Bins(R0Bins), fCosTheta0Min(cosTh0Min), fCosTheta0Max(cosTh0Max), fCosTheta0Bins(cosTh0Bins), fRhoInt(NULL), fRhoSInt(NULL), fRhoSSInt(NULL), fRhoSSpline(NULL), fRhoSSSpline(NULL)
{
...
WCSimIntegralLookupHistArray::WCSimIntegralLookupHistArray(const WCSimIntegralLookupHistArray &other) : fEMin(other.fEMin), fEMax(other.fEMax), fR0Min(other.fR0Min), fR0Max(other.fR0Max), fR0Bins(other.fR0Bins), fCosTheta0Min(
																																																						other.fCosTheta0Min),
																										fCosTheta0Max(other.fCosTheta0Max), fCosTheta0Bins(other.fCosTheta0Bins), fRhoInt(
																																													  NULL),
																										fRhoSInt(NULL), fRhoSSInt(NULL), fRhoSSpline(NULL), fRhoSSSpline(NULL)
{
