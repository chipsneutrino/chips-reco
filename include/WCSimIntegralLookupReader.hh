...
public:
	...
	double GetRhoGIntegral(const TrackType::Type &type, const double &E, const double &s, const double &R0,
						   const double &cosTh0);
	double GetRhoGSIntegral(const TrackType::Type &type, const double &E, const double &s, const double &R0,
							const double &cosTh0);
	double GetRhoGSSIntegral(const TrackType::Type &type, const double &E, const double &s, const double &R0,
							 const double &cosTh0);
	virtual ~WCSimIntegralLookupReader();

	void SaveIntegrals(const TrackType::Type &type, const double E, const double s, const double R0,
					   const double cosTh0);
