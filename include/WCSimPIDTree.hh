...
class WCSimPIDTree : public TObject
{
	public:
		...
		float GetDeltaCharge2LnLOverNHits(){ return deltaCharge2LnLOverNHits; }

		float GetFracHitsOutsideRing_mu(){ return fracHitsOutsideRing_mu; }
		float GetFracHitsInRing_mu(){ return fracHitsInRing_mu; }
		float GetFracHitsInRingHole_mu(){ return fracHitsInRingHole_mu; }
		float GetFracHitsOutsideRing_el(){ return fracHitsOutsideRing_el; }
		float GetFracHitsInRing_el(){ return fracHitsInRing_el; }
		float GetFracHitsInRingHole_el(){ return fracHitsInRingHole_el; }

		float GetFracQOutsideRing_mu(){ return fracQOutsideRing_mu; }
		float GetFracQInRing_mu(){ return fracQInRing_mu; }
		float GetFracQInRingHole_mu(){ return fracQInRingHole_mu; }
		float GetFracQOutsideRing_el(){ return fracQOutsideRing_el; }
		float GetFracQInRing_el(){ return fracQInRing_el; }
		float GetFracQInRingHole_el(){ return fracQInRingHole_el; }

		float GetFracPredQOutsideRing_mu(){ return fracPredQOutsideRing_mu; }
		float GetFracPredQOutsideRing_el(){ return fracPredQOutsideRing_el; }

		float GetPredictedChargeOverTotalCharge_mu(){ return predictedChargeOverTotalCharge_mu; }
		float GetPredictedChargeOverTotalCharge_el(){ return predictedChargeOverTotalCharge_el; }

		float GetRecoEOverQ_mu(){ return recoEOverQ_mu; }
		...
		float GetLastRingHeight(){ return lastRingHeight; }
		...
		int GetTrueType(){ return trueType; }
		int GetTrueBeamPDG(){ return trueBeamPDG; }
		int GetTrueCCEvent(){ return trueCCEvent; }
		int GetTrueNCEvent(){ return trueNCEvent; }
		int GetTrueQEEvent(){ return trueQEEvent; }
		int GetTrueResEvent(){ return trueResEvent; }
		int GetTrueDISEvent(){ return trueDISEvent; }
		int GetTrueCohEvent(){ return trueCohEvent; }
		int GetTrueNueElectronElasticEvent(){ return trueNueElectronElasticEvent; }
		int GetTrueInverseMuonDecayEvent(){ return trueInverseMuonDecayEvent; }
		...
		TTree * GetOutputTree(){ return PIDOutputTree; }
