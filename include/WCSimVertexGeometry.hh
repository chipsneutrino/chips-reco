...
public:
	...
	void CalcResiduals(Double_t vx, Double_t vy, Double_t vz, Double_t vtxTime, Double_t px, Double_t py,
					   Double_t pz);

	void CalcPointResiduals(Double_t vx, Double_t vy, Double_t vz, Double_t vtxTime, Double_t px, Double_t py,
							Double_t pz);
	void CalcExtendedResiduals(Double_t vx, Double_t vy, Double_t vz, Double_t vtxTime, Double_t px, Double_t py,
							   Double_t pz);
...
private:
	...
	void ChooseNextQuadruple(Double_t &x0, Double_t &y0, Double_t &z0, Double_t &t0, Double_t &x1, Double_t &y1,
							 Double_t &z1, Double_t &t1, Double_t &x2, Double_t &y2, Double_t &z2, Double_t &t2, Double_t &x3,
