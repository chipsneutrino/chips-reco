...
class WCSimHitPrediction: public TObject {
	public:
		...
		WCSimHitPrediction(double predQ, double predT, double total2LnL, double charge2LnL, double time2LnL,
				double hit2LnL) :
				fPredictedCharge(predQ), fPredictedTime(predT), fTotal2LnL(total2LnL), fCharge2LnL(charge2LnL), fTime2LnL(
						time2LnL), fHit2LnL(hit2LnL), fCutoff2LnL(total2LnL - charge2LnL - time2LnL) {
		}
...
class WCSimSingleHitComparison {
	...
	public:
		WCSimSingleHitComparison(WCSimLikelihoodDigit digit, WCSimHitPrediction bestFit, WCSimHitPrediction correctFit) :
		...
		WCSimSingleHitComparison() :
				fDigit(
						WCSimLikelihoodDigit(-9999.9, -9999.9, -9999.9, -9999.9, 0, -999, -9999.9, -9999.9, -9999.9, "",
								0x0, 0, 0)), fBestFit(WCSimHitPrediction(0, 0, 0, 0, 0, 0)), fCorrectFit(
