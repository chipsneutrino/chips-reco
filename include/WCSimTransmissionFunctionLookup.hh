...
public:
  ...
  inline double const GetXMin() { return fXMin; }
  inline double const GetXMax() { return fXMax; }
  inline double const GetNorm() { return fNorm; }
  inline double const GetNu() { return fNu; }
private:
	void MakeLUT();
	double fXMin;
	double fXMax;
