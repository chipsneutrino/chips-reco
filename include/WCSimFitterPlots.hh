...
class WCSimFitterPlots {
	...
	public:
		...
		bool GetMake2DSurface(const char * name, const char * name2, unsigned int trackNum = 0, unsigned int trackNum2 =
				0) const;
		...
		double Get2DSurfaceBinCenterX(
				std::pair<std::pair<unsigned int, FitterParameterType::Type>,
						std::pair<unsigned int, FitterParameterType::Type> > theProfile, int binNumX);
		double Get2DSurfaceBinCenterY(
				std::pair<std::pair<unsigned int, FitterParameterType::Type>,
						std::pair<unsigned int, FitterParameterType::Type> > theProfile, int binNumY);
		void Fill2DProfile(
				std::pair<std::pair<unsigned int, FitterParameterType::Type>,
						std::pair<unsigned int, FitterParameterType::Type> > theProfile, int binNumX, int binNumY,
				double minus2LnL);
	...
	private:
		...
		std::map<
				std::pair<std::pair<unsigned int, FitterParameterType::Type>,
						std::pair<unsigned int, FitterParameterType::Type> >, TH2D*> fSurfaces2D;
