...
class WCSimPiZeroHoughSeeder: public WCSimPiZeroSeeder {
	...
	private:
		...
		double FitTwoTracks();
		void SetStartingEnergies(WCSimRecoRing* ring1, WCSimRecoRing* ring2, WCSimLikelihoodTrackBase* track1,
		...
		std::vector<std::pair<WCSimLikelihoodTrackBase*, WCSimLikelihoodTrackBase*> > fHoughResults;ClassDef(WCSimPiZeroHoughSeeder,0);
