...
class WCSimLikelihoodTunerCache {
	public:
		...
		WCSimLikelihoodTunerCache(double const &s, WCSimLikelihoodDigit const * digit,
...
class WCSimLikelihoodTuner {
	public:
		 ...
		 */
		std::vector<Double_t> CalculateJ(Double_t s, WCSimLikelihoodTrackBase * myTrack,
		 ...
		 */
		std::vector<Double_t> CalculateCoefficientsVector(WCSimLikelihoodTrackBase * myTrack,
				WCSimLikelihoodDigit * myDigit);
