void pidPlots(){
  ...
  const char* nueFileName = "/unix/chips/jtingey/CHIPS/code/SimAndReco/WCSimAnalysis/pid/chips_1200_default/elAllOutput.root";
  const char* numuFileName = "/unix/chips/jtingey/CHIPS/code/SimAndReco/WCSimAnalysis/pid/chips_1200_default/muAllOutput.root";
  ...
  pt1->AddText("Preselection & e vs. NC ANN > 0.93 cuts applied to initial sample of 95% #nu_{#mu}, 5% #nu_{e}");

  TPaveText * pt2 = new TPaveText(0.18, 0.89, 0.845, 0.84, "blNDC");
  pt2->AddText("Preselection & e vs. #mu ANN > 0.81 cuts applied to initial sample of 95% #nu_{#mu}, 5% #nu_{e}");
  ...
  // All events
  TH1F* hAll_ElMu= new TH1F("hAll_ElMu",";numuCCQE vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  ...
  TH1F* hAll_ElNc = new TH1F("hAll_ElNc",";NC vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  ...
  // All NC events
  TH1F* hNC_ElMu = new TH1F("hNC_ElMu",";numuCCQE vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  hNC_ElMu->SetLineColor(kRed-2);
  hNC_ElMu->GetYaxis()->CenterTitle();
  hNC_ElMu->GetXaxis()->CenterTitle();
  TH1F* hNC_ElNc = new TH1F("hNC_ElNc",";NC vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  hNC_ElNc->SetLineColor(kRed-2);
  hNC_ElNc->GetYaxis()->CenterTitle();
  hNC_ElNc->GetXaxis()->CenterTitle();
  // Muon CC events
  TH1F* hNumuCC_ElMu = new TH1F("hNumuCC_ElMu",";numuCCQE vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  hNumuCC_ElMu->SetLineColor(kRed);
  hNumuCC_ElMu->GetYaxis()->CenterTitle();
  hNumuCC_ElMu->GetXaxis()->CenterTitle();
  TH1F* hNumuCC_ElNc = new TH1F("hNumuCC_ElNc",";NC vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  hNumuCC_ElNc->SetLineColor(kRed);
  hNumuCC_ElNc->GetYaxis()->CenterTitle();
  hNumuCC_ElNc->GetXaxis()->CenterTitle();
  // Electron CC events
  TH1F* hNueCC_ElMu = new TH1F("hNueCC_ElMu",";numuCCQE vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  ...
  TH1F* hNueCC_ElNc = new TH1F("hNueCC_ElNc",";NC vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  ...
  TH1F* hNueCCQE_ElMu = new TH1F("hNueCCQE_ElMu",";numuCCQE vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  ...
  TH1F* hNueCCQE_ElNc = new TH1F("hNueCCQE_ElNc",";NC vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  ...
  // All events
  TH1F* hAll_ElMu_cuts= new TH1F("hAll_ElMu_cuts",";numuCCQE vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  ...
  TH1F* hAll_ElNc_cuts = new TH1F("hAll_ElNc_cuts",";NC vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  ...
  // All NC events
  TH1F* hNC_ElMu_cuts = new TH1F("hNC_ElMu_cuts",";numuCCQE vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  hNC_ElMu_cuts->SetLineColor(kRed-2);
  hNC_ElMu_cuts->GetYaxis()->CenterTitle();
  hNC_ElMu_cuts->GetXaxis()->CenterTitle();
  TH1F* hNC_ElNc_cuts = new TH1F("hNC_ElNc_cuts",";NC vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  hNC_ElNc_cuts->SetLineColor(kRed-2);
  hNC_ElNc_cuts->GetYaxis()->CenterTitle();
  hNC_ElNc_cuts->GetXaxis()->CenterTitle();
  // Muon CC events
  TH1F* hNumuCC_ElMu_cuts = new TH1F("hNumuCC_ElMu_cuts",";numuCCQE vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  hNumuCC_ElMu_cuts->SetLineColor(kRed);
  hNumuCC_ElMu_cuts->GetYaxis()->CenterTitle();
  hNumuCC_ElMu_cuts->GetXaxis()->CenterTitle();
  TH1F* hNumuCC_ElNc_cuts = new TH1F("hNumuCC_ElNc_cuts",";NC vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  hNumuCC_ElNc_cuts->SetLineColor(kRed);
  hNumuCC_ElNc_cuts->GetYaxis()->CenterTitle();
  hNumuCC_ElNc_cuts->GetXaxis()->CenterTitle();
  // Electron CC events
  TH1F* hNueCC_ElMu_cuts = new TH1F("hNueCC_ElMu_cuts",";numuCCQE vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  ...
  TH1F* hNueCC_ElNc_cuts = new TH1F("hNueCC_ElNc_cuts",";NC vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  ...
  // Electron CCQE events
  TH1F* hNueCCQE_ElMu_cuts = new TH1F("hNueCCQE_ElMu_cuts",";numuCCQE vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
  ...
  TH1F* hNueCCQE_ElNc_cuts = new TH1F("hNueCCQE_ElNc_cuts",";NC vs. nueCCQE ANN value;Events (arb. units)", 50, -0.5, 1.5);
