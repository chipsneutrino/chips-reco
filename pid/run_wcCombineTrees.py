...
#
#  Script to produce combined  Trees file used for WCSimaAnalysis Neural Network PID 
#  training
#  Arguments are:
...
def run_wcCombineTrees(argv):
    ...
    #:::::::::::::::  Check Arguments   :::::::::::::::::::::::::::::::::::::::::::
    if len(argv) < 2:
        print "usage: run_wcCombineTrees.py   mu_list  el_list   [output_dir] [common_name]"
        exit(1)
    ...
    for mu_line, el_line  in zip(mu_lines, el_lines):
        ...
        cmd = ("root -l -q \'$WCSIMANAHOME/pid/run_wcCombineTrees.C(\"%s\",\"%s\", \"%s\")\'" % (mu_line.split("\n")[0], el_line.split("\n")[0], outname) )
        print cmd
        os.system(cmd)
