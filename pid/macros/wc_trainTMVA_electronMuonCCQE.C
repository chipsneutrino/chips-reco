...
void wc_trainTMVA_electronMuonCCQE( TString sigFile, TString bkgNumuCCFile, TString PIDDir)
{
    ...
    TFile* outputFile = TFile::Open( (weightsDir + "/tmva_nueCCQE_vs_numuCCQE.root").c_str(), "RECREATE" );
