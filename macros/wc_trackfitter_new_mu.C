void wc_trackfitter_new_mu(const char * infile = "", int start=0, int fit=100){
  ...
  myFitter.SetParameter(0, "kVtxX", -1200, 1200, 0, false, 10.0);
  myFitter.SetParameter(0, "kVtxY", -1200, 1200, 0, false, 10.0);
  myFitter.SetParameter(0, "kVtxZ",  -950, 950, 0, false, 10.0);
  ...
  myFitter.SetParameter(0, "kEnergy", 500, 5000, 1000, false, 25.0);
