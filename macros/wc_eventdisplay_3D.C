{
  ...
  WCSimInterface::LoadData("/unix/fnu/ajperch/sampleEvents/WCSimOutput/nue_chips_me_1000_rightVtx.root");//../mcSamples/muonZ.root");//numi_numu_NC_100kT_10pC_Leigh.root");
