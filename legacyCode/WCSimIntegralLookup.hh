...
class WCSimIntegralLookupHists {
	public:
		...
		WCSimIntegralLookupHists(THnSparseF * rhoInt, THnSparseF * rhoSInt, THnSparseF * rhoSSInt, THnSparseF * rhoGInt,
				THnSparseF * rhoGSInt, THnSparseF * rhoGSSInt, TH1F * cutoffS);
		...
		void SetHists(THnSparseF * rhoInt, THnSparseF * rhoSInt, THnSparseF * rhoSSInt, THnSparseF * rhoGInt,
				THnSparseF * rhoGSInt, THnSparseF * rhoGSSInt, TH1F * cutoffS);
...
class WCSimIntegralLookup {
	...
	private:
		...
		double GetIntegral4D(const double &E, const double &s, const double &R0, const double &cosTh0,
				THnSparseF * hist);
