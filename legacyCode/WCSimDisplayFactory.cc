...
WCSimDisplay* WCSimDisplayFactory::MakeDisplay(const char *name) {
	...
	if (strcmp(name, "AB") == 0 || strcmp(name, "default") == 0) {
		if (fDisplayAB == 0) {
	...
	else if (strcmp(name, "Eve") == 0 || strcmp(name, "EVE") == 0 || strcmp(name, "3D") == 0) {
		if (fDisplayEve == 0) {
			std::cout << "   Building Display: " << name << std::endl;
	...
	else if (strcmp(name, "Vtx") == 0 || strcmp(name, "VTX") == 0 || strcmp(name, "Vertex") == 0) {
		if (fDisplayVtx == 0) {
			std::cout << "   Building Display: " << name << std::endl;
