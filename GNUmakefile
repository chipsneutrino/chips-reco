...
$(ROOTDICT) : $(ROOTSRC)
	rootcint -f $(ROOTDICT) -c -I$(INCDIR) -I$(WCSIM_INCDIR) -I$(shell root-config --incdir) WCSimPiZeroFitter.hh WCSimDetectorParameters.hh WCSimTimePredictor.hh WCSimTimeLikelihood2.hh WCSimLikelihoodTrackFactory.hh WCSimLikelihoodTrackBase.hh WCSimLikelihoodPhotonTrack.hh WCSimFitterTrackParMap.hh WCSimIntegralLookupMaker3D.hh WCSimIntegralLookup3D.hh WCSimIntegralLookupReader.hh WCSimIntegralLookup.hh WCSimIntegralLookupMaker.hh WCSimRecoEvDisplay.hh WCSimRecoSummary.hh WCSimEmissionProfileManager.hh WCSimEmissionProfiles.hh WCSimFitterConfig.hh WCSimFitterInterface.hh WCSimFitterParameters.hh WCSimFitterTree.hh WCSimFitterPlots.hh WCSimTimeLikelihood.hh WCSimAnalysisConfig.hh WCSimDigitizerLikelihood.hh WCSimTotalLikelihood.hh WCSimLikelihoodTrack.hh WCSimLikelihoodDigit.hh WCSimLikelihoodDigitArray.hh WCSimChargePredictor.hh WCSimLikelihoodTuner.hh WCSimLikelihoodFitter.hh WCSimDisplayViewer.hh WCSimDisplayFactory.hh WCSimDisplay.hh WCSimDisplayAB.hh WCSimEveDisplay.hh WCSimEventWriter.hh WCSimGeometry.hh WCSimInterface.hh WCSimParameters.hh WCSimRecoObjectTable.hh WCSimRecoFactory.hh WCSimReco.hh WCSimRecoAB.hh WCSimRecoDigit.hh WCSimRecoCluster.hh WCSimRecoClusterDigit.hh WCSimRecoRing.hh WCSimRecoVertex.hh WCSimRecoEvent.hh WCSimTrueEvent.hh WCSimTrueTrack.hh WCSimHoughTransform.hh WCSimHoughTransformArray.hh WCSimDataCleaner.hh WCSimVertexFinder.hh WCSimVertexGeometry.hh WCSimVertexViewer.hh WCSimRingFinder.hh WCSimRingViewer.hh WCSimNtupleFactory.hh WCSimNtuple.hh WCSimRecoNtuple.hh WCSimVertexNtuple.hh WCSimVertexSeedNtuple.hh WCSimNtupleWriter.hh WCSimMsg.hh WCSimRecoSlicer.hh WCSimRecoSeed.hh WCSimAnalysisRootLinkDef.hh
